...
const styles = StyleSheet.create({
  ...
  iconButton: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: Colors.secondary, // Icon background remains as defined
  ...
  backButton: {
    backgroundColor: Colors.backbutton, // Specific background for the back button remains
  },
  iconImage: {
    width: 24,
    height: 24,
...
export default HeaderinnerStore;
